...
private KnihaDao knihaDao 
    ...
    private void initComponents() {
        ...
        jLogo.setIcon(new javax.swing.ImageIcon("D:\\Skola\\PAZ_PROJEKT\\logoBook-paz1c.gif")); // NOI18N
        ...
        btnPridaj.setFocusPainted(false);
        btnPridaj.setFocusable(false);
        btnPridaj.setOpaque(false);
        btnPridaj.setRequestFocusEnabled(false);
        btnPridaj.setRolloverEnabled(false);
        btnPridaj.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnPridajActionPerformed(evt);
            }
        });
        getContentPane().add(btnPridaj, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 250, 60, 20));
        ...
        getContentPane().add(btnOdstran, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 250, -1, 20));

        btnUprav.setText("Uprav");
        btnUprav.setFocusPainted(false);
        btnUprav.setOpaque(false);
        btnUprav.setRequestFocusEnabled(false);
        btnUprav.setRolloverEnabled(false);
        btnUprav.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnUpravActionPerformed(evt);
            }
        });
        getContentPane().add(btnUprav, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 250, -1, 20));

        btnNazvu.setText("Nazvu");
        btnNazvu.setFocusPainted(false);
        btnNazvu.setFocusable(false);
        btnNazvu.setOpaque(false);
        btnNazvu.setRequestFocusEnabled(false);
        btnNazvu.setRolloverEnabled(false);
        ...
        btnDetail.setRequestFocusEnabled(false);
        btnDetail.setRolloverEnabled(false);
        ...
        btnKosik.setFocusPainted(false);
        btnKosik.setFocusable(false);
        btnKosik.setOpaque(false);
        btnKosik.setRequestFocusEnabled(false);
        btnKosik.setRolloverEnabled(false);
        btnKosik.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnKosikActionPerformed(evt);
            }
        });
        getContentPane().add(btnKosik, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 250, 140, 20));

        btnPodlaAutora.setText("Autora");
        btnPodlaAutora.setFocusPainted(false);
        btnPodlaAutora.setFocusable(false);
        btnPodlaAutora.setOpaque(false);
        btnPodlaAutora.setRequestFocusEnabled(false);
        btnPodlaAutora.setRolloverEnabled(false);
        ...
        getContentPane().add(jPozadie, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 470, 230));
    ...
    private void btnPridajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPridajActionPerformed
        UpravitKnihaForm upravitKnihaForm = new UpravitKnihaForm(this);
        upravitKnihaForm.setVisible(true);
    ...
    private void btnOdstranActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOdstranActionPerformed
        ...
        if(tlacidlo == JOptionPane.YES_OPTION) {
            knihaDao.odstranit(vybrataKniha);    
            aktualizujZoznamKnih();            
        }
    ...
    private void btnUpravActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpravActionPerformed
        ...
        UpravitKnihaForm upravitKnihaForm 
                = new UpravitKnihaForm(vybrataKniha, this);
        upravitKnihaForm.setVisible(true);
